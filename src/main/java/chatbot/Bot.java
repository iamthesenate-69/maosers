...
import chatbot.moderation.QuizResponse;
...
public class Bot {
	...
	Commands[] commandlist = { new Rename(), new AbandonShip(), new IBMarks(), new CheckVC(), new Help(), new Ban(), new Vaporize(), new Quiz(), new Bilingual(), new Funny(), new Paimon(), new OpenFile(), new Sudo(), new Pogrom(), new ImperativeFrenchJudge()};
	Moderations[] moderationlist = {new TyrantSlurs(), new PingRemover(), new FirstQuote(), new SecondQuote(), new ThirdQuote(), new ForthQuote(), new FifthQuote(), new QuizResponse(), new NoNitroAllowed(), new Okay(), new Ok()};
